...
1. [Debt Cannot Be Measured](./debt-cannot-be-measured.md)
2. [Developers Cannot Report It Either](./developers-cannot-report.md)
3. [Overengineering Is Debt Whose Trial Has Not Come](./overengineering-is-debt-whose-trial.md)

It prepares the final two essays:

4. [Code as Score](./code-as-score.md)
5. [Designing for Local Return](./designing-for-local-return.md)
